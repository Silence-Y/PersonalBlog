<template>
  <table>
    ...
    <tbody>
      <tr>
        <router-link :to="{name: 'editBlog', }" tag="td" class="title">文章标题</router-link>
        <td>便签</td>
        <td>信息</td>
        <td>
          <router-link :to="{name: 'editBlog', }" class="iconfont icon-biji-copy" tag="i"></router-link>
          <i class="iconfont icon-shanchu" @click="deleteConfirm()"></i>
        </td>
      </tr>
    </tbody>
    <tfoot>
